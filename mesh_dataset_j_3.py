...
def custom_collate_fn(batch, masking_ratio_range=(0.3, 0.7), clusters_to_select=10, num_pred_blocks=2):
    """
    ...
    - Multiple prediction mask blocks are generated per sample (num_pred_blocks).
    ...
    for clusters in batch:
        ...
        for _ in range(num_pred_blocks):
            ...
            for cluster_idx in selected_clusters:
                ...
                # (context mask is not changed here, only prediction mask)
